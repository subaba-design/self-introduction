...
const Header = (props) => {
    ...
    const list = () => (
        ...
        >
            ...
            <Divider />
            <List>
                <a href="https://twitter.com/subaba_design" className="header-list-item">
                    <ListItem button key={ state.LINK_Twitter }>
                        <ListItemText primary={ state.LINK_Twitter } />
                    </ListItem>
                </a>
                <a href="https://subaba-design.com" className="header-list-item">
                    <ListItem button key={ state.LINK_Blog }>
                        <ListItemText primary={ state.LINK_Blog } />
                    </ListItem>
                </a>
                <a href="https://github.com/subaba-design" className="header-list-item">
